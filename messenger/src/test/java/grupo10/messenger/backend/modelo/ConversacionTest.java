...
class ConversacionTest {
    ...
    void testGetters() {
        ...
        assertEquals(contacto, conversacion.getContacto(), "El contacto debería ser el mismo.");
        assertEquals("User1", conversacion.getContactoNickname(), "El nickname del contacto debería ser 'User1'.");
        assertEquals("192.168.1.1", conversacion.getContactoIp(), "La IP del contacto debería ser '192.168.1.1'.");
        assertEquals(8080, conversacion.getContactoPort(), "El puerto del contacto debería ser 8080.");
    }
