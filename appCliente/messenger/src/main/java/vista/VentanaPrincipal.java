...
public class VentanaPrincipal extends javax.swing.JFrame implements IVista{
    ...
    private FormularioEditarContacto editarContacto;
    ...
    public void agregarContacto(Contacto contacto)
    {
        ...
        contactoItemList = new ContactoItemList(controlador,nickname);
    ...
    public void actualizarContacto(String nicknameViejo, Contacto contacto)
    {
        for(Component c: menuList.getComponents())
        {
             ...
             {
                contactoVista.setNickname(contacto.getNicknameAgendado());
                break;
             }
        }
    }
    ...
    public void agregarConversacion(Conversacion conversacion) 
    {
        ...
        conversacionItemList = new ConversacionItemList(controlador, contacto.getNicknameAgendado());
    ...
    public void setNicknameActivo(String nicknameActivo) {
        this.nicknameActivo = nicknameActivo;
        this.nicknameConversacion.setText(nicknameActivo);
    }
    ...
    public String getNicknameContactoEditado() {
        return editarContacto.getNicknameContactoEditado();
    } 
    
    public String getNicknameContactoActual() {
        return editarContacto.getNicknameContactoActual();
    } 
