...
public class MensajeVista extends JTextArea{
    ...
    public MensajeVista(String text, boolean esMio, String hora) {
        super(text);  
        this.setWrapStyleWord(true);  
        this.setLineWrap(true);       
        this.setEditable(false);  
        this.setMargin(new Insets(5, 10, 5, 10));  
        this.setBorder(BorderFactory.createLineBorder(Constantes.COLOR_BASE, 2, true)); 
        this.setBackground(esMio ? Constantes.COLOR_MENSAJE : Color.WHITE); 
        ponerFecha(hora);  
        ajustarTamaño();  
    }

    private void ponerFecha(String hora) {
